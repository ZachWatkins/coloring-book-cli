...
const DEFAULT_BUILD_URL = 'https://pkmncards.com/wp-content/uploads/clc_en_003-charizard.png';
const DEFAULT_BUILD_OPTIONS = {
    src: 'charizard.png',
    dest: 'images/charizard.png',
    regions: [
...
if (process.argv.includes('--no-interaction')) {
    build(DEFAULT_BUILD_OPTIONS).then(() => console.log('Created: images/charizard.png'));
} else {
